            ...
            <fieldset>
              ...
              <div class="content-table">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="password" id="psw" name="password" value = " " class="form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                   ...
                   <input type="password" id="repsw" name="re-password" class="form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                   <div id="message">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="tel" id="phone" name="phone" placeholder="" class="form-control" pattern="^\d{10}$" title="Must contain 10 numbers" required>
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="date" id="daybirth" name="ngaysinh" placeholder="" class="form-control">
                </div>
              </div>
              <div class="control-group">
                <!-- Username -->
