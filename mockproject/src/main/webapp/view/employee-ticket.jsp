...
<script src="/mockproject/view/js/jquery.min.js"></script>
<script src="/mockproject/view/js/bootstrap.min.js"></script>
<script src="/mockproject/view/js/jquery.twbsPagination.js"></script>
<link href="/mockproject/view/css/bootstrap.min.css" rel="stylesheet"
	type="text/css">

<!-- Custom fonts for this template -->
<link href="/mockproject/view/css/all.min.css" rel="stylesheet"
	type="text/css">

<!-- Page level plugin CSS -->
<link href="/mockproject/view/css/dataTables.bootstrap4.css"
	rel="stylesheet">

<!-- Custom styles for this template-->
<link href="/mockproject/view/css/sb-admin.css" rel="stylesheet">
<link href="/mockproject/view/css/MyStyle.css" rel="stylesheet">
</head>
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="sidebar navbar-nav">
			...
			<li class="nav-item active"><a class="nav-link"
				href="#page-top"> <i class="fas fa-fw fa-table"></i> <span>Tickets</span></a>
			</li>
			<li class="nav-item active"><a class="nav-link" href="#page-top">
	...
	<script src="/mockproject/view/js/bootstrap.bundle.min.js"></script>

	<!-- Core plugin JavaScript  -->
	<script src="/mockproject/view/js/jquery.easing.min.js"></script>

	<!-- Page level plugin JavaScript-->
	<script src="/mockproject/view/js/jquery.dataTables.js"></script>
	<script src="/mockproject/view/js/dataTables.bootstrap4.js"></script>

	<!-- Custom scripts for all pages-->
	<script src="/mockproject/view/js/sb-admin.min.js"></script>

	<!-- Demo scripts for this page-->
	<script src="/mockproject/view/js/datatables-demo.js"></script>
</body>
</html>