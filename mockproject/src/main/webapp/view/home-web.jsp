    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li><a href="${pageContext.request.contextPath}/view/login.jsp" onclick="document.getElementById('id01').style.display='block'"
              style="width:auto;"><span class="glyphicon glyphicon-log-in"></span> LOGIN</a></li>
          <li><a href="${pageContext.request.contextPath}/view/register.jsp" onclick="document.getElementById('id02').style.display='block'"
