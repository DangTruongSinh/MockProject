	...
	<div class="container-fluid bg">
			<div class="row justify-content-center">
				<div class="col-md-3 col-sm-6 col-xs-12 row-container">
					...
					<div>
						<label><a style="color:#2196F3 " href="${pageContext.request.contextPath}/view/register.jsp" class="lbLink">Registers</a></label> <label><a
							href="#" id="passbtn" class="lbLink" style="color:#2196F3 ">Forgot Password?</a></label>
					</div>
					...
					<div id="backhomeText">
						<label><a href="${pageContext.request.contextPath}/home-web" class="homeLink">Back
								to Home</a></label>
					</div>
				</div>
