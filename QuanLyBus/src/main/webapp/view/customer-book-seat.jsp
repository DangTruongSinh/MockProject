...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li><a href="Login.html" onclick="document.getElementById('id01').style.display='block'"
              style="width:auto;"><span class="glyphicon glyphicon-log-in"></span> LOGIN</a></li>
          <li><a href="Register.html" onclick="document.getElementById('id02').style.display='block'"
  ...
  <div class="container">
    ...
    <div class="col-sm-8">
      <div class="well">
        <p>Tuyến xe</p>
        <input type="text" style="color: red" disabled value ="${bus.placeStart} - ${bus.placeEnd}">
        <p>Giờ khởi hành</p>
        <input class="input-start" disabled type="text" name="time-input" value="${bus.getGioBatDau()}">
        ...
        <c:url var="urlBack" value="/customer-ticket">
        	<c:param name="action" value = "ticket"/>
	   		...
	   		<c:param name="startPlace" value="${bus.placeStart}"/>
	   		<c:param name="endPlace" value="${bus.placeEnd}"/>
	   		<c:param name="date" value="${bus.getDateKhoiHanh()}"/>>
        </c:url>
        <div style="display: flex;">
        	<a href="${urlBack}"><button class="btn btn-success">Quay lại</button></a>
        	<form action="/QuanLyBus/customer-ticket" id = "formDat">
